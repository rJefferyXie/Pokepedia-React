    ...
    <section id="Hero" className="flex-col">
      <div id="Hero-wrapper" className="page-container flex">
        <div id="Left-hero-wrapper" className="flex-col">
          <h1 style={{margin: "auto", width: "100%", textAlign: "center"}}>Welcome to Pokepedia!</h1>
          <p style={{margin: "0px auto 20px", width: "100%", textAlign: "center"}}>Revisit your favorite pokemon memories and adventures with us.</p>
